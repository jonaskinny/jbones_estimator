...
/**
   Class that represents a Complexity DTO.
*/
public class Complexity extends BaseADTO implements Copyable {
   ...
   */
   public Object copy(Object o) throws ObjectCopyException, CloneNotSupportedException, NoSuchMethodException {
      ...
      throw new ObjectCopyException("Object " + o + " of Class " + ClassName.name(o.getClass()) + " cannot be copied as a Complexity");
   }
}
