...
public class EffortEditServlet extends VelocityViewServlet {
   ...
   public Template handleRequest(HttpServletRequest request,HttpServletResponse response, Context context) {
      try {
         ...
         // jcole fix npe here where user manually enters update url but no EffortActionBean is in request yet.
         context.put("effort", effortActionBean.getEffort());
         context.put("unitTypeList", effortActionBean.getUnitTypeList());
         context.put("complexityList", effortActionBean.getComplexityList());
         context.put("phaseList", effortActionBean.getPhaseList());
         context.put("effortMessageList", MessageConverter.convert(effortActionBean.getContext().getMessages()));

         Template t = null;
         
         t = getTemplate("EffortEdit.vm");
