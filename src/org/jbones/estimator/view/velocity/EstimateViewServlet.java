...
public class EstimateViewServlet extends VelocityViewServlet {
   ...
   public Template handleRequest(HttpServletRequest request,HttpServletResponse response, Context context) {
      try {
         ...
         EstimateEffortActionBean estimateEffortActionBean = (EstimateEffortActionBean)(request.getAttribute("estimateEffort"));
