...
public class EstimateArchiveListServlet extends VelocityViewServlet {
   ...
   public Template handleRequest(HttpServletRequest request,HttpServletResponse response, Context context) {
      try {
         ...
         context.put("estimateArchiveList", estimateActionBean.getEstimateArchiveList());
         context.put("estimateMessageList", MessageConverter.convert(estimateActionBean.getContext().getMessages()));

         Template t = null;
         
         t = getTemplate("EstimateArchiveList.vm");
